...
const Contact = () => {
  ...
  }; // The return must be INSIDE the Contact function
    ...
    >
      ...
      <div className="container mx-auto">
        ...
        <p className="text-gray-600 dark:text-gray-400 text-center max-w-2xl mx-auto mb-12">
          ...
          hear from           you. Send me a message and let's discuss your
          ideas!        {" "}
        </p>{" "}
               {" "}
          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                ...
                creative ideas,                 or partnerships. Feel free to
...
}; // This closing bracket now correctly ends the Contact function
